        ...
        <div flex flex-col gap-6>
          ...
          <div flex gap-4 border-default-b pb-6 sm:gap-6>
            <el-skeleton-item
              ...
              class="flex-shrink-0 border-default card-default shadow-sm"
            />
            <div flex flex-1 flex-col gap-2 py-1>
              <el-skeleton-item variant="text" style="width: 10rem; height: 1.2rem;" />
              <el-skeleton-item variant="text" style="width: 8rem; height: 0.9rem;" />
              <el-skeleton-item variant="text" style="width: 9rem; height: 0.8rem;" />
            </div>
          </div>
          <!-- 群详情骨架屏 -->
          <div flex flex-col gap-6 border-default-b pb-6>
            ...
            <div class="h-8 flex gap-2">
              <el-skeleton-item variant="circle" style="width: 2rem; height: 2rem;" />
              <el-skeleton-item variant="circle" style="width: 2rem; height: 2rem;" />
              <el-skeleton-item variant="circle" style="width: 2rem; height: 2rem;" />
              <el-skeleton-item variant="circle" style="width: 2rem; height: 2rem;" />
            </div>
    ...
    <template v-else>
      ...
      <div class="mx-a">
        <CommonElButton
          ...
          @click="chat.exitGroupConfirm(roomId, isGroupOwner, () => {
